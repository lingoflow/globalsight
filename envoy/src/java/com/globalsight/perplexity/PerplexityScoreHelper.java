 ...
 * 
 */
package com.globalsight.perplexity;
...
import com.globalsight.perplexity.vo.PerplexityAccount;
import com.globalsight.perplexity.vo.PerplexityLanguageModulePair;
import com.globalsight.perplexity.vo.PerplexityScores;
...
public class PerplexityScoreHelper
{
    ...
    public static final String URL_POST_SCORE = "/api/v1/score/";// the last "/" is required
     ...
     * @param sourceLanguage -- Optional.
     * @param targetLanguage -- Optional.
     * 
...
//            long lmpairId = 1L;
            ...
            String scoresJson = helper.getPerplexityScoreInJSON(accessToken, host, lmpairId, sourceList,
                    targetList);
        ...
        {
            // NOTE that HttpClient must be closed after an unit running is finished.
